...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Infrastructure \& System Support:}{ Terraform, Infrastructure automation, Shell scripting, Jenkins Groovy, Ansible (some experience), Linux/RHEL administration, macOS system management, capacity testing} \\ \vspace{3pt}

        \textbf{Monitoring \& Infrastructure:}{ Grafana, Active Directory, JIRA} \\ \vspace{3pt}

        \textbf{Cloud:}{ AWS, Azure (DevOps, Databricks), GCP, Docker, Kubernetes} \\ \vspace{3pt}

        \textbf{CI/CD:}{ GitHub Actions, Jenkins, Azure DevOps Pipelines} \\ \vspace{3pt}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Platform Engineer, Data Transformation Scrum Team}{Nov 2025 \textbf{--} Current}
        \resumeItemListStart
            \resumeItem{Platform Engineer in the Data Transformation Scrum Team, working in Agile sprints via JIRA to deliver data platform infrastructure and address critical data challenges across availability, consumption, governance, and strategy.}
            \resumeItem{Build and maintain infrastructure using Terraform for Infrastructure as Code, GitHub Actions for CI/CD pipelines, and Azure DevOps for project delivery and automated workflows.}
            \resumeItem{Develop and manage data pipelines and analytics workloads on Azure Databricks, ensuring data ingestion pipelines meet near real-time needs for marketing and business use cases.}
            \resumeItem{Perform RHEL VM provisioning, configuration, and administration using Linux CLI for platform infrastructure supporting the data ecosystem.}
            \resumeItem{Strengthen data governance by defining clear data ownership and stewardship, and develop local data strategy aligned with the group's overall strategy to create a single source of truth with common data definitions and governance standards.}
        \resumeItemListEnd
