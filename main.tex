...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Infrastructure \& System Support:}{ Infrastructure automation, Shell scripting, Jenkins Groovy, Ansible (some experience), Linux (intermediate), macOS system management, capacity testing} \\ \vspace{3pt}
